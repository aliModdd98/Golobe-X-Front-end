...
const AddingCard = ({ onCloseClick }) => {
  ...
  return (
    <>
      <Container >
        <div className={`BigCard ${!ShowCard ? 'hidden' : ''}`}>
          <svg className='close' xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none" onClick={onCloseClick} >
